...
int spl_load_simple_fit(struct spl_load_info *info, ulong sector, void *fit)
{
	 ...
	 * block, we may load it up to one block before the load address. So
	 * take account of that here by subtracting an addition block length
	 * from the FIT start position.
	 *
