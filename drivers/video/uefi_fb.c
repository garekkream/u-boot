...
static int parse_uefi_table_fb(GraphicDevice *gdev)
{
	struct uefi_framebuffer *fb = lib_sysinfo.framebuffer;
...
void *video_hw_init(void)
{
	...
	if (!parse_uefi_table_fb(gdev)) {
		printf("No video mode configured in uefi!\n");
		return NULL;
	}
